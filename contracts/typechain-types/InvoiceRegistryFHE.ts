...
export interface InvoiceRegistryFHEInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "cancelInvoice"
      | "createInvoice"
...
export interface InvoiceRegistryFHE extends BaseContract {
  connect(runner?: ContractRunner | null): InvoiceRegistryFHE;
  waitForDeployment(): Promise<this>;

  interface: InvoiceRegistryFHEInterface;
